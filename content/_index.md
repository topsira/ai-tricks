...
{{< hextra/hero-badge >}}
  ...
  <span>Knowledge Base · เปิด Public</span>
{{< /hextra/hero-badge >}}

<div class="hx-mt-6 hx-mb-6">
{{< hextra/hero-headline >}}
  คลังความรู้ AI&nbsp;<br class="sm:hx-block hx-hidden" />สำหรับงาน Technical
{{< /hextra/hero-headline >}}
</div>

<div class="hx-mb-12">
{{< hextra/hero-subtitle >}}
  AI Tricks, Prompt Engineering, AI Coding Workflow และ Tool Notes&nbsp;<br class="sm:hx-block hx-hidden" />เน้นใช้งานจริง ไม่ใช่ทฤษฎี — ทุก Note มีส่วน Safety / Verification
{{< /hextra/hero-subtitle >}}
</div>
